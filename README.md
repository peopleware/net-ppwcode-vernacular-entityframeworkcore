# PPWCode.Vernacular.EntityFrameworkCore

This library is part of the .NET PPWCode project and contains an Entity Framework Core specific implementation for persistence, with support for the following relational databases: Microsoft SQL Server and PostgreSQL.
